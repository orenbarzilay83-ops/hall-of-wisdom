...
const CROSS_CUTTING_ENTRIES = [
  {
    ...
    requiredInputs: ['board', 'explicit hiddenThoughtIntent', 'explicit Dhamir method selection'],
    applicableQuestionTypes: ['hiddenThoughtIntent'],
    blockedQuestionTypes: [],
    clientVisibility: 'advisorOnly',
    evidenceLocation: { file: 'goral-hachol/engine/kashf-dhamir.js', exportOrFunction: 'computeDhamirByMajority / computeSelectedDhamirMethod', sourceSnippetIdentifier: null },
    confidence: 'medium',
    notes: 'כלל הרוב של עמ׳ 155 נשמר כידע-מקור וכפונקציה, אך מנותק מ-runtime ברירת-המחדל. runtime מפעיל שיטת דמיר אחת בלבד לאחר hiddenThoughtIntent מאושר ובחירה מפורשת; אין auto-run ואין majority vote אוטומטי.',
  },
  {
    method: 'kashf',
    sourceId: KASHF_SOURCE_ID,
    ...
    confidence: 'low',
    notes: 'לא נובע מספר כשף עצמו (external). אינו מחושב כברירת מחדל; נדרש enableExternalDhamirType4=true מפורש, והוא נשאר advisor-only ואינו משתתף בפסק.',
  },
  {
    method: 'kashf',
    sourceId: KASHF_SOURCE_ID,
    ...
    confidence: 'medium',
    notes: 'החבילה אינה רצה אוטומטית. נדרש enableDhamirExtras=true ובית דמיר שכבר נבחר במסלול need-driven; אין sectionId client נפרד לעיתוי/טמפרמנט.',
  },
  {
    method: 'kashf',
    sourceId: KASHF_SOURCE_ID,
