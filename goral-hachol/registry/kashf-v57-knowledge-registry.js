...
export const KASHF_V57_KNOWLEDGE = Object.freeze({
  ...
  'hidden.p185.recursiveQuarterFireAir': knowledge({
    kashfMethodId: 'hidden.p185.recursiveQuarterFireAir',
    page: 185,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'איתור רקורסיבי בארבעה רבעים — אש ואוויר',
    hebrewRule: 'בעמ׳ 185 נמסר חישוב רקורסיבי: מצרפים את נקודות האש למניין השם הנדרש, מפחיתים בארבע־ארבע וקובעים רבע לפי השארית: 1 מזרח, 2 מערב, 3 דרום, 4 צפון. בתוך הרבע שנבחר חוזרים על החישוב בנקודות האוויר ובשם, וממשיכים לצמצם את המקום.',
    arabicVerificationPages: [185],
    notes: 'באותו דפוס נאמר שיש שישה־עשר מקומות וכל אחד נחלק לארבעה, אך הסך המודפס הוא أربعة وتسعين — 94. אין לתקן ל־64 ואין להפעיל runtime עד שהסתירה תיפתר ממקור.',
  }),

  'hidden.p186.nameDayAbjadQuarter': knowledge({
    kashfMethodId: 'hidden.p186.nameDayAbjadQuarter',
    page: 186,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'כיוון לפי שם, שם האם והיום',
    hebrewRule: 'עמוד באמצע המקום ופנה אל הקִבְּלָה. חשב בגימטריה הגדולה את שם השואל, שם אמו והיום שבו נשאלת השאלה, הפחת בארבע־ארבע: שארית 1 מזרח, 2 מערב, 3 דרום, 4 צפון.',
    arabicVerificationPages: [186],
    notes: 'זהו מסלול נפרד הדורש קלטי שם/אם/יום וחישוב אבג׳ד ייעודי; אין להסיק אותו מן הלוח ואין לצרפו להצבעה עם שיטות כיוון אחרות.',
  }),

  'hidden.p186.tamtamFourQuarterCasts': knowledge({
    kashfMethodId: 'hidden.p186.tamtamFourQuarterCasts',
    page: 186,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'שיטת טמטם — ארבע הטלות לארבעה רבעים',
    hebrewRule: 'חלק את המקום לארבעה רבעים והוצא צורה לכל כיוון. פנימית ומיטיבה מורה שיש שם מן המבוקש; מזיקה וחיצונית מורה שאין שם. אם שלושה רבעים ריקים/חיצוניים ואחד פנימי ומיטיב — המבוקש ברבע המיטיב. אם שניים מיטיבים ושניים מזיקים — מוציאים שתי צורות ביניים ומהן צורה מסכמת.',
    arabicVerificationPages: [186],
    notes: 'שתי צורות הביניים בענף 2+2 הן חלק מפורש מן הדפוס. השיטה מחייבת זרימת ארבע הטלות ייעודית ואינה זהה לשיטת עמ׳ 188.',
  }),

  'hidden.p187.kindRootDirection': knowledge({
    kashfMethodId: 'hidden.p187.kindRootDirection',
    page: 187,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'מין הדבר הנסתר וכיוון שורשו',
    hebrewRule: 'קח מן היתדות שתי צורות והוצא משתיהן צורה שלישית. לפי יסודה: אש — סמוך לאש; אוויר — תלוי/באוויר; מים — סמוך למים; עפר — טמון בעפר. אחר כך התבונן היכן שורש הצורה בסידור: באמהות — מזרח; בבנות — מערב; במאזנים — דרום; ענף המֻנְשַׁאַת תלוי במילת הכיוון הקשה שבדפוס.',
    arabicVerificationPages: [187],
    notes: 'מילת הכיוון בענף المنشآت מופיעה בדפוס כ־ناحية الجاه ואינה מאומתת כ״צפון״. לכן השיטה חסומה לחישוב ואין להשלים את הכיוון מסימטריה.',
  }),
  ...
  'hidden.p188.quarterDirection': knowledge({
    ...
    supportingPages: [54, 57, 58, 59, 60],
    arabicVerificationPages: [188],
    notes: 'השיטה מחייבת ארבע הטלות/צורות נוספות לפי ארבעת חלקי המקום; אין להסיק אותן מן הלוח הקיים. זהו המסלול היחיד שנבחר ל־q-dig-direction; שיטות עמ׳ 185, 186, 187 ו־190 נשמרות בנפרד ואינן מצביעות עמו.',
  }),

  'hiddenDepth.p188-189.openElementLengths': knowledge({
    kashfMethodId: 'hiddenDepth.p188-189.openElementLengths',
    page: 188,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'עומק לפי היסודות הפתוחים',
    hebrewRule: 'לדעת עומק מים או דבר נסתר נמסר סולם: אש — אצבע; אוויר — שעל/זרת־מתוחה; מים — אמה; עפר — קומה. אחר כך יש לקחת מן הצורה המורה את היסודות הפתוחים ולחשב את אורכיהם לפי סידור האותיות והניגודים. בדוגמה שבעמ׳ 189 הסך הוא שתי אצבעות ושעל אחד.',
    detailPages: [189],
    arabicVerificationPages: [188, 189],
    notes: 'אין runtime עד שסדר היסודות הפתוחים, סידור האותיות/הניגודים וצבירת המידות יהיו ניתנים למבחן זהב. אין להחליף זאת בסיווג היסוד הכללי של הצורה או בטבלת טמטם.',
  }),

  'waterDepth.p189-190.tamtamTable': knowledge({
    kashfMethodId: 'waterDepth.p189-190.tamtamTable',
    page: 189,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'טמטם ההודי — עומק המים',
    hebrewRule: 'לפי שיטת טמטם לעומק המים: השלם שש־עשרה צורות; הוצא צורה מ־H1+H12, צורה שנייה מ־H12+H9, ומהשתיים הוצא צורה שלישית. את הצורה האחרונה מפרשים לפי טבלת המידות המודפסת בעמ׳ 189–190.',
    detailPages: [190],
    arabicVerificationPages: [189, 190],
    notes: 'שרשרת ההולדה נשמרת בדיוק: H1+H12; H12+H9; ואז מן שתי התוצאות. אין לערבב את טבלת טמטם עם סולם היסודות הפתוחים של עמ׳ 188–189.',
  }),

  'hidden.p190.nearFarElementDirection': knowledge({
    kashfMethodId: 'hidden.p190.nearFarElementDirection',
    page: 190,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'קרוב או רחוק וכיוון לפי הכוכב והיסוד',
    hebrewRule: 'בדין קרוב/רחוק והדרך: הירח ומאדים מורים על קרוב; כוכב וכוכב צדק מורים על דרך קשה ופחד; שבתאי בבית הראשון מורה על דרך קוצנית. לפי יסוד H1: אוויר — צפון; אש — מזרח; עפר — קִבְּלָה; מים — מערב.',
    detailPages: [191],
    arabicVerificationPages: [190, 191],
    notes: 'זהו דין נפרד מן הטלות ארבעת הרבעים ומדיני העומק; אין להשתמש בו כהצבעת תמיכה למסלול q-dig-direction.',
  }),

  'hidden.p190-191.recursiveHouseTriangles': knowledge({
    kashfMethodId: 'hidden.p190-191.recursiveHouseTriangles',
    page: 190,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'צמצום רקורסיבי בתוך הבית',
    hebrewRule: 'אם הדבר הנסתר בתוך בית, חלק את הבית לארבעה כיוונים, ובכל כיוון נאמר اضرب لكل جهة مثلثة. מקום שבו יוצאות צורות ריקות — אין בו; מקום שבו יוצאות צורות מלאות — שם הדבר. את הרבע שנבחר מחלקים שוב לארבעה וממשיכים עד שנשאר המקום המדויק.',
    detailPages: [191],
    arabicVerificationPages: [190, 191],
    notes: 'המונח הטכני مثلثة אינו מוגדר בקטע. אין להפוך אותו לצורה רגילה אחת, ולכן המסלול חסום עד לפתרון מקור.',
  }),
  ...
  'matter.p172.locationH2H16': knowledge({
    kashfMethodId: 'matter.p172.locationH2H16',
    page: 172,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'באיזה בית עניינו ורווחו/קניינו של השואל',
    hebrewRule: 'כדי לדעת באיזה בית מצויים עניינך ורווחך/קניינך, קח את הבית השני ואת הבית השישה־עשר והעמד מהם צורה; מן התוצאה אמור לדעת את הבית.',
    arabicVerificationPages: [172],
    verificationNotes: 'המקור אומר أمرك وكسبك — עניינך ורווחך/קניינך; אין לצמצם את המונח לממון בלבד.',
    notes: 'הקטע אינו מגדיר כאן כיצד ממפים את הצורה המתקבלת לבית יעד. לכן הידע נשמר, אך ההליך חסום תפעולית ואין לשאול מיפוי ממסורת אחרת.',
  }),

  'friend.p173.uniqueTariqBalance': knowledge({
    kashfMethodId: 'friend.p173.uniqueTariqBalance',
    page: 173,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'ידיד איש או אישה — דרך יחידה במאזן',
    hebrewRule: 'השלם את הלוח עד המאזן. אם יצאה דרך במאזן ואין בלוח צורה אחרת כדוגמתה — הידיד אוהב אותו. ואם יש לדוגמת דרך הופעה בבית השביעי — הידיד פונה לאחר.',
    arabicVerificationPages: [173],
    notes: 'זהו כלל ידיד/כיוון אהבה מצומצם, לא כלל אהבה כללי. אין להפעילו כאשר צורת המאזן אינה דרך.',
  }),

  'hope.p174.h5h11ThroughH1': knowledge({
    kashfMethodId: 'hope.p174.h5h11ThroughH1',
    page: 174,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'האם התקווה תתקיים',
    hebrewRule: 'קח את הבית החמישי ואת הבית האחד־עשר, והכה כל אחד מהם בבית הראשון כך שיוצאות שתי צורות. הוצא משתי הצורות צורה שלישית. אם היא מיטיבה ופנימית — הבקשה נענית; מיטיבה וחיצונית — מתעכבת ואחר כך נענית; מזיקה ופנימית — מושגת בעמל; מזיקה וחיצונית — עדיף לעזוב אותה.',
    arabicVerificationPages: [174],
    verificationNotes: 'המקור המודפס אומר במפורש שיוצאות שתי צורות ביניים ומהן מוציאים צורה נוספת.',
    notes: 'v57 הישן קיצר את שתי תוצאות הביניים לצורה אחת. עד שהנוסח התפעולי יתוקן ומבצע יוסמך, השיטה אינה רצה.',
  }),

  'authority.p175-176.needBeforeRulerChain': knowledge({
    kashfMethodId: 'authority.p175-176.needBeforeRulerChain',
    page: 175,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'צורך אצל השלטון — שרשרת בתי הבדיקה',
    hebrewRule: 'בשאלה על צורך אצל השלטון השלם את הלוח ובדוק את הבית הראשון ואת העשירי לפי יסוד ואיכות; אחר כך את בית התקווה ביחס לעשירי, את הבית השני לדיני ממון/טובין, ואת בתי בעלי החיים והמשרתים ושאר בתי האחרית כפי שמפרט המקור.',
    detailPages: [176],
    arabicVerificationPages: [175, 176],
    verificationNotes: 'בענף H2 הקבוע המקור אומר المتاع واليسار — השגת מטלטלין/טובין ורווחה; אין תוצאה מקבילה לאש/אוויר לפני המעבר ל-H11.',
    notes: 'זו מסגרת מקור אחת לשאלה על צורך אצל שלטון. אין להפוך כל תת־סעיף לכלל רקע אוניברסלי.',
  }),

  'request.p176.h1h2GateThenH1H4': knowledge({
    kashfMethodId: 'request.p176.h1h2GateThenH1H4',
    page: 176,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'קיום בקשה — שער H1/H2 ואחרית H1+H4',
    hebrewRule: 'בדוק תחילה את הבית הראשון והשני. אם אחד מהם מזיק — עזוב את הבקשה. אם השער עבר, הוצא צורה מן הראשון והרביעי: מיטיבה מורה טובה, שלום ואחרית טובה; מזיקה מורה חולשת אחרית, עמל וקושי; ממוזגת מורה אחרית בינונית.',
    supportingPages: [54, 57, 58, 59, 60],
    arabicVerificationPages: [176],
    notes: 'אין לדלג על שער H1/H2 ואין למזג את הכלל עם שיטות אחרות לבקשה.',
  }),

  'intent.p176.h7h10': knowledge({
    kashfMethodId: 'intent.p176.h7h10',
    page: 176,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'כוונת אדם — H7+H10',
    hebrewRule: 'להכרת כוונת אדם, הוצא צורה מן הבית השביעי והעשירי. אם יצאה מיטיבה — הכוונה לטובה; ואם יצאה מזיקה — לרעה/נחס.',
    supportingPages: [54, 57, 58, 59, 60],
    arabicVerificationPages: [176],
    notes: 'שיטה זו עומדת בפני עצמה ואינה אחת משיטות הדמיר של שער רביעי.',
  }),

  'meeting.p176.hopeHouseH1H13': knowledge({
    kashfMethodId: 'meeting.p176.hopeHouseH1H13',
    page: 176,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'האם ייפגש עם האדם המבוקש',
    hebrewRule: 'אם בית התקווה יוצא בבית הראשון ובבית השלושה־עשר — השואל ייפגש עם מי שהוא מבקש; ואם לא — לא.',
    arabicVerificationPages: [176],
    notes: 'הביטוי “בית התקווה” דורש ייצוג תפעולי מאושר לפני חישוב; אין להחליפו בבית אחד בלבד.',
  }),

  'person.p177.relativeThirteenth': knowledge({
    kashfMethodId: 'person.p177.relativeThirteenth',
    page: 177,
    topic: 'השער השישי — דיני שנים־עשר הבתים; הפרק הראשון — הנפש',
    heading: 'עולה האדם — העד הקרוב והבית השלושה־עשר היחסי',
    hebrewRule: 'לוקחים את הבית הנשאל ומכים אותו בעד הקרוב; את התוצאה מכים בבית השלושה־עשר היחסי של אותו בית, ואחר כך דנים לפי סדר ענפי מיטיב/מזיק, יסוד וטבע התנועה שהמקור מפרט.',
    arabicVerificationPages: [177],
    verificationNotes: 'במקור נשארים פתוחים המונחים معموم ו־ولا يحصل معارك; סדר ענפים מסוים עדיין משובש ב-v57, והכללת הבית השלושה־עשר היחסי לכל בית דורשת מיפוי מאומת.',
    notes: 'REFERENCE_ONLY. אין לבצע מיפוי יחסי, לתקן תחביר או למלא את המונחים הקשים לפי היגיון או מסורת אחרת.',
  }),
  ...
  'matter.p172.h17_h1011_thenCombine': knowledge({
    ...
    hebrewRule: 'לאחר השלמת הלוח עד הבית השישה־עשר, הוצא צורה מן הבית הראשון והשביעי, וצורה נוספת מן העשירי והאחד־עשר. אחר כך צרף אותן; הצורה היוצאת מהן היא תוצאת עניינו של השואל — לטוב או לרע.',
    supportingPages: [54, 57, 58, 59, 60],
    arabicVerificationPages: [172],
    verificationNotes: 'הסריקה המודפסת מקדימה במפורש את השלמת הקו עד H16; שכבת v57 הישנה השמיטה תנאי פתיחה זה.',
    notes: 'שיטה זו נפרדת משיטת השלמת העניין בעמוד 173. המבצע הקנוני מקבל לוח מלא של 16 בתים; אין לבצע את ההולדות על לוח חלקי. את הצורה הסופית שופטים לפי סיווג הטוב/הרע הקנוני; צורה ממוזגת נשארת ממוזגת ואינה נהפכת אוטומטית למיטיבה או למזיקה.',
  }),
  ...
  'debt.p179.creditorDebtorWalking': knowledge({
    ...
    page: 179,
    topic: 'הפרק השני — דיני הממון',
    heading: 'בעל החוב, החייב ותנועת הממון',
    hebrewRule: 'בשאלת תביעה כספית: הבית הראשון הוא בעל החוב; מן השביעי והתשיעי מעמידים צורה לחייב, ומן השני והשנים־עשר צורה לממון. המקור ממשיך בענפי “הלך שניים” ו“הלך שלושה”, בהיעדר צורת החייב מן “היד”, ובמקרים שבהם “פרח” או “בכר” הלכו.',
    arabicVerificationPages: [179],
    verificationNotes: 'הסריקה המודפסת מאמתת את לשון مشى إثنين / مشى ثلاثة / غاب عن اليد ואת השמות فرح / بكر, אך אינה מגדירה כאן את מיפוים החישובי באופן מספיק להפעלה.',
    notes: 'חסום ב-runtime. אין לזהות את פרח/בכר עם צורות אחרות מן הדעת, אין לפרש “יד” כמערך הקוד, ואין להמציא חשבון הליכה.',
  }),

  'money.p180.elementComparison': knowledge({
    kashfMethodId: 'money.p180.elementComparison',
    page: 180,
    topic: 'הפרק השני — דיני הממון',
    heading: 'השוואת ממון הנשאל והשואל לפי יסודות',
    hebrewRule: 'לממון הנשאל מעמידים צורה מן הבתים 2,4,6,8; לממון השואל מעמידים צורה מן 1,3,5,7. משווים את יסודות שתי הצורות לפי אש=1, אוויר=2, מים=3, עפר=4. המקור מורה להביט ביסוד התחתון, לשמרו ולעבוד לפי מספרו — “וזהו הממון”.',
    supportingPages: [122, 123],
    arabicVerificationPages: [180],
    verificationNotes: 'השלב האחרון אינו מגדיר כיצד המספר הנשמר נהפך לערך ממון בפועל.',
    notes: 'חסום ב-runtime עד שהמרת היסוד/המספר לסכום תיסגר מן המקור עצמו. אין להחליף זאת בשיטת כניסה/יציאה או בשיטת סכום עמ׳ 182.',
  }),

  'money.p181.otherBookRemainder': knowledge({
    kashfMethodId: 'money.p181.otherBookRemainder',
    page: 181,
    topic: 'הפרק השני — דיני הממון',
    heading: 'מן ספר אחר — שיטת שארית לממון ולמקורו',
    hebrewRule: '“ומן ספר אחר”: השלם את היד עד שש־עשרה צורות, מנה את נקודותיהן והפחת שתיים־שתיים; שארית אחת — אין ממון, שארית שתיים — ממון רב. מיד לאחר מכן נמסרת טבלת שאריות 1–7 למקור הממון: שלטון, נשים, ספר/כתיבה, ירושה, מסע, מסחר, גניבה.',
    arabicVerificationPages: [181],
    verificationNotes: 'הפחתה בשתיים אינה יכולה כשלעצמה להפיק את טבלת 1–7 שבאותו קטע; הסתירה קיימת במקור המודפס.',
    notes: 'REFERENCE_ONLY / educational. אין לשנות את המחלק לשבע, אין להשמיט ענפים ואין לצרף את השיטה להצבעה עם שיטות הממון הראשיות.',
  }),

  'money.p182.h2h10Outlook': knowledge({
    kashfMethodId: 'money.p182.h2h10Outlook',
    page: 182,
    topic: 'הפרק השני — דיני הממון',
    heading: 'בית הממון והפרנסה — H2+H10',
    hebrewRule: 'אם רצית לשאול על בית ממונך ופרנסתך, התבונן בבית השני ובעשירי — בית הפרנסה — והעמד מהם צורה; היא מודיעה את כל הטוב והרע בעניין.',
    supportingPages: [54, 57, 58, 59, 60],
    arabicVerificationPages: [182],
    notes: 'זהו הנתיב הקנוני לשאלה הכללית על מצב הממון. צורה מיטיבה נותנת ענף טוב, מזיקה ענף רע, וממוזגת נשארת ללא פסק בינארי. אין לצרף את שיטות p179–p181 או בדיקות topic ישנות.',
  }),

  'money.p182.lawfulnessInclination': knowledge({
    kashfMethodId: 'money.p182.lawfulnessInclination',
    page: 182,
    topic: 'הפרק השני — דיני הממון',
    heading: 'האם הממון מותר או אסור',
    hebrewRule: 'אם נשאלת על ממון אם הוא מותר או אסור, העמד צורה מן הבית התשיעי והאחד־עשר. אם הצורה היוצאת נוטה אל התשיעי — הממון מותר; ואם היא נוטה אל האחד־עשר — הממון אסור.',
    arabicVerificationPages: [182],
    verificationNotes: 'המקור המודפס נותן את הכלל במפורש, אך אינו מגדיר כאן כיצד מחשבים את “הנטייה” של הצורה היוצאת אל אחד משני הבתים.',
    notes: 'חסום ב-runtime עד שמנגנון הנטייה יוגדר מקור־נאמנה. אין להמציא affinity לפי יסוד, מושב, חזרה או כבוד.',
  }),
  ...
  'relocation.p183.compare12vs78': knowledge({
    kashfMethodId: 'relocation.p183.compare12vs78',
    page: 183,
    topic: 'הפרק השלישי — אחים ומעבר',
    heading: 'איזו משתי ערים טובה יותר',
    hebrewRule: 'בשאלת מעבר — איזו משתי הערים טובה יותר — התבונן בראשון, בשני, בשביעי, בשמיני, בתשיעי ובאחרית, ובתנאי של צורות מיטיבות. אם הראשון והשני חזקים יותר, המקום הנוכחי טוב יותר; ואם השביעי והשמיני חזקים יותר, המעבר טוב יותר.',
    arabicVerificationPages: [183],
    notes: 'המקור המודפס משמר תנאי מיטיבים אך אינו מגדיר כאן כיצד מודדים ״חזקים יותר״ או כיצד H9 ואחרית העניין נכנסים להשוואת החוזק. לכן השיטה ניתנת לאחזור אך חסומה לחישוב, ואין להמציא ציון חוזק.',
  }),

  'relocation.p184.multiIndicatorStayMove': knowledge({
    kashfMethodId: 'relocation.p184.multiIndicatorStayMove',
    page: 184,
    topic: 'הפרק השלישי — אחים ומעבר',
    heading: 'סימנים נוספים לשהייה או מעבר',
    hebrewRule: 'בעמ׳ 184 נמסרו סימנים נוספים: עדות מיטיבה דרך השישי והשביעי מורה על טובה בשהייה במקום; מיטיבים בראשון ובשנים־עשר מורים על טובה במעבר למקום המבוקש; ואם השני פנימי — השהייה טובה.',
    arabicVerificationPages: [184],
    notes: 'הקטע אינו קובע סדר עדיפות או כלל הכרעה כאשר הסימנים מתנגשים. לכן אין לצרף אותם להצבעה, ואין להשתמש בהם במקום אחת משיטות עמ׳ 183 שנבחרה לפי כוונת השאלה.',
  }),

  'property.p184-185.houseGardenMap': knowledge({
    kashfMethodId: 'property.p184-185.houseGardenMap',
    page: 184,
    topic: 'הפרק הרביעי — הורים, נכסים ודברים נסתרים',
    heading: 'נכסים, בית וגן — מפת הבתים',
    hebrewRule: 'בשאלת בית או גן: הבית הרביעי מורה על הקרקע; העשירי על העצים; השביעי על הירקות/הצמחים (הבְּקוֹלוֹת); השלישי על תעלות המים; והשני על החומה המקיפה. במקום שבו נמצאות צורות מיטיבות — דון לטובה; במקום מזיקים — להפך. בראש עמ׳ 185 נאמר שההסתמכות היא על העדים.',
    detailPages: [184, 185],
    arabicVerificationPages: [184, 185],
    notes: 'המיפוי H7=צמחים ו-H3=תעלות מים אומת מול הדפוס ואינו מוחלף. הקטע אינו מגדיר מחדש איזו מערכת עדים יש להפעיל, ולכן כל המפה נשארת חסומה ל-runtime עד שהעדים ייסגרו ממקור. אין לייבא מערכת עדים מפרק אחר.',
  }),
