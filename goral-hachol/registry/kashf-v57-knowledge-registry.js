...
export const KASHF_V57_KNOWLEDGE = Object.freeze({
  ...
  'inheritance.p180.elementComposite': knowledge({
    ...
    hebrewRule: 'אם שאל השואל על אדם: האם הוא יורש אותי או שאני יורש אותו? קח עפר מן הראשון, מים מן השני, אוויר מן השלישי ואש מן הרביעי, והוצא מהם צורה. אחר כך קח אש מן החמישי, אוויר מן השישי, מים מן השביעי ועפר מן השני, והוצא מהם צורה. משתי הצורות הוצא צורה שלישית. אם הצורה הסופית מחלקו של השואל — אמור: אתה יורש אותו; ואם היא מחלקו של הנשאל עליו — אמור: הוא יורש אותך.',
    supportingPages: [64, 65, 66],
    arabicVerificationPages: [180],
    verificationNotes: 'בדיקה חוזרת של הערבית המודפסת בעמ׳ 180 מראה שהנוסח הקודם ב-v57 השמיט את הצורה הראשונה ואת החיבור בין שתי הצורות. עמ׳ 64–66 מחלקים את שש־עשרה הצורות במפורש לשמונה צורות طالبة (טאלב) ושמונה مطلوبة (מטלוב), והחלוקה הזאת משמשת כאן לפענוח “מחלקו של השואל / מחלקו של הנשאל”.',
    notes: 'השיטה קובעת רק איזה צד יורש את האחר. היא אינה מחשבת חלקי ירושה, סכומים או מחלוקת בירושה.',
  }),
