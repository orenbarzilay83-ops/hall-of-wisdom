...
const KASHF_LAYER = [
  ...
  mk({
    ...
    category: 'executable-inference-engine',
    system: 'kashf',
    runtimeRole: 'conditional-explicit-selection',
    moduleStyle: 'ES-module-pure',
    publicExports: ['computeDhamirMizan', 'computeDhamirHarkatAlArd', 'computeDhamirJawharayn',
      'computeDhamirDoubledSquare', 'computeDhamirElementPrevalence', 'computeSelectedDhamirMethod',
      'computeDhamirByMajority', 'KASHF_DHAMIR_NEED_DRIVEN_POLICY', 'KASHF_DHAMIR_IMPLEMENTED_METHOD_CATALOG', 'default'],
    confidenceBehavior: 'single explicitly-selected method at runtime; source majority helper preserved but disconnected from default execution',
    executionStatus: 'connected-conditional',
    testStatus: 'indirect-only',
  ...
  mk({
    ...
    category: 'executable-inference-engine',
    system: 'kashf',
    runtimeRole: 'explicit-external-opt-in',
    moduleStyle: 'ES-module-pure',
