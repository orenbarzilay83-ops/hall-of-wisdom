...
function validateRasDhanabInHouse1(house1) {
  ...
  return {
    ...
    hebrewMessage:
      ...
      `${isRas ? 'ראש התלי (المزاج الفاسد)' : 'זנב התלי (المزاج الفاسد)'}. ` +
      'לפי המקור: יש לדון בה בזהירות ולשקול לחזור ולהפיל מחדש.',
...
function validateLiarFiguresPresent(entries) {
  ...
  return {
    ...
    hebrewMessage:
      ...
      'לפי המקור: אם אין ולא אחת מהן — השאלה אינה כנה או הלוח לא תקין.',
