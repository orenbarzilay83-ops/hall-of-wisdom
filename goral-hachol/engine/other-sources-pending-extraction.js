...
// שני ערכים שהוצאו מטבלת FIRST_FIGURE_REPETITIONS ב-hawi-interpreter.js
// (חזרת הצורה הראשונה N פעמים בלוח) — הם היחידים באותה טבלה בת 16
// ערכים שנשאו ציטוט מפורש למקור שאינו חאווי. שאר 14 הערכים בטבלה נשארו
// במקומם כי אין להם ציטוט סותר, אך גם הם לא אומתו מחדש מול ספר חאווי
// בבדיקה הזו — ראה CLAUDE.md, סטטוס "not-yet-found-in-current-code-search".
export const FIRST_FIGURE_REPETITIONS_NON_HAWI = {
