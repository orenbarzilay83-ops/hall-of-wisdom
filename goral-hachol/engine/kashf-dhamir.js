 ...
 *     מול טבלת המקור מעמ' 97-99 (ממון נכנס וסוהר אינם מקבלים בה שורה —
 *     לא הומצא להם ערך); ההחזרה למושב לפי SHIBUTZ_1_MOSHAV (עמ' 104-105).
...
// אינה נותנת שורה ל-2 מתוך 16 הצורות (ממון נכנס וסוהר) — לא הומצא
// עבורן ערך.
// נגזר מ-FIGURE_DIGNITIES (kashf-figure-attributes-gate2.js) — מקור יחיד
// לטבלת המעלה, כדי למנוע סטייה בין שני עותקים. ממון נכנס/סוהר נשארים
// undefined בהתאם.
