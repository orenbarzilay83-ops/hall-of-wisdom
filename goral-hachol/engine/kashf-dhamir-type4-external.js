...
export const TYPE4_EXTERNAL_DISCLOSURE_HEBREW =
  'תוצאה זו משתמשת בשיטת המרה שאינה מבוססת על ספר כשף אל-אסרר עצמו, ' +
  'אלא על מקור חיצוני משלים — כדי להשלים פעולת "מספר → אות" שכשף קובע ' +
  'כללית בלבד וללא דוגמה מספרית. שיוך האות לצורה נשאר מבוסס על כשף אל-אסרר במלואו.';
