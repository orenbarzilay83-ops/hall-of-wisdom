...
const TOPIC_MAIN_HOUSES = {
  travel:           [1, 3, 5, 8, 9, 11, 12],
  missingPerson:    [1, 7, 8, 9, 11, 12],
  childrenPregnancy:[1, 4, 5, 6, 7, 11, 12, 13, 14, 15],
  hiddenTreasure:   [1, 2, 4, 6, 7, 8, 10, 11, 12, 15, 16],
  ...
  disputes:         [1, 7, 11, 12, 13, 14, 15],
  enemies:          [1, 7, 9, 11, 12, 13, 14, 15],
  fear:             [1, 4, 11, 12, 13, 14, 15],
  commerce:         [1, 2, 7, 10, 11, 12, 13, 14, 15],
  loveHate:         [1, 5, 7, 11, 12, 13, 14, 15],
  ...
  siblings:         [1, 3, 7, 11, 12, 13, 14, 15],
  deathInheritance: [1, 2, 7, 8, 11, 12, 13, 14, 15],
};
...
function computeBoardScore(chart) {
  ...
  return {
    ...
    hebrewSummary: score >= 90
      ? `לוח שלם (${score} נקודות ≥ 90)`
      : `לוח חסר (${score} נקודות < 90) — השאלה עשויה שלא להיפתר`,
  };
}
