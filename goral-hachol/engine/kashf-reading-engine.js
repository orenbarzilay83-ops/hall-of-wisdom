...
const ILLNESS_BY_ELEMENT = {
  fire:  'מן המרה הצהובה — חום יבש (כשף עמ׳ 197)',
  air:   'מרוחות שונות ומחלות אוויריות (כשף עמ׳ 197)',
  water: 'מצד קור ולחות, כגון בהרת ודומה לה (כשף עמ׳ 197)',
  earth: 'מן המרה השחורה — קור יבש (כשף עמ׳ 197)',
};
