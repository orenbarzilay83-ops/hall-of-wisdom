  ...
  generalReading: {
    ...
    supportingChecks: [
      ...
      },
      {
        ...
        sourceText: 'אם בעשירי ובאחד־עשר צורות מיטיבות — מלאכתו מעטה בטרחה. לפי כוכב הצורה בבית התשיעי — סוג המלאכה (שבתאי: חקלאות; צדק: חכמות; מאדים: רפואה; שמש: הנדסה; נוגה: לחנים; כוכב: כתיבה וחשבונות; לבנה: ענייני עניים) (כשף עמ׳ 254).',
      },
      {
        id: 'clothing-luck',
        checkType: 'legacy-fn',
