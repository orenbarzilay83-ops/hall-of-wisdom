...
// 'combine':           חיבור רמל של N בתים → צורה חדשה → סעד/נחס או כרינ׳/דח׳ל
// 'assemble':          "העמד מהם צורה" מ-4 בתים (כל שורות) → סעד/נחס
// 'house-quality':     בדיקת בית יחיד — האם הוא סעד/נחס
// 'count-quality':     ספירת סעד/נחס בקבוצת בתים
