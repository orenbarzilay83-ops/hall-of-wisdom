...
export const KASHF_TOPIC_RULES = {
  ...
  money: {
    ...
    // "סכום הממון" (עמ' 182) מפנה לשיטת ספירת-שנים שאינה מזוהה בבירור במקור
    // (אין נוסחה נפרדת ומפורשת ל"שנות חיים" באזור זה של הספר) — אינה מקודדת.
    additionalMethods: [
      {
        id: 'money-magnitude-by-years-method',
        label: 'סכום/גודל הממון — לפי שיטת מספר השנים',
        sourceStatus: 'not-explicit-in-source',
        sourceText: 'אשר למספר הממון — דון בו כדין מספר השנים: הצורות המורות על שנים הן אלפים, החודשים מאות, והימים עשרות (כשף עמ׳ 182). שיטת "מספר השנים" עצמה (שאליה מפנה נוסחה זו) אינה מזוהה במקור באזור זה בניסוח מפורש דיו לקידוד בטוח.',
      },
    ],
    keyHouses: [2, 6, 8, 10],
  },
