  ...
  generalReading: {
    ...
    supportingChecks: [
      ...
      },
      {
        ...
        sourceText: 'כבוד נכנס, לבן ובר הלחי בבית החמישי — מן הצורות המועדפות לפריסת לבוש ותפירה (כשף עמ׳ 196).',
      },
      {
        id: 'promise-fulfillment',
        checkType: 'legacy-fn',
        fnName: 'computePromiseFulfillmentKashf',
        houses: [1, 2, 3, 8, 9, 11, 15],
        label: 'קיום הבטחה',
        sourceText: 'אם בראשון דרך — הבטחות רבות ומשאלות בטלות. אם סוהר — הבטחה אמתית עם עיכוב אפשרי. אם השני או התשיעי צורה מתהפכת — הוא מפר את ההבטחה. לפי רוב הבתים הראשון, השלישי, השמיני, התשיעי, האחד-עשר והחמישה-עשר — מיטיבים או מזיקים (כשף עמ׳ 255).',
      },
      {
