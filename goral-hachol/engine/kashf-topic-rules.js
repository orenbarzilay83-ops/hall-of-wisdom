  ...
  disputes: {
    ...
    supportingChecks: [
      ...
      },
      {
        ...
        houses: [4],
        lookupTable: {
          '1212': 'העיר תילקח בתחבולה',
          '1222': 'תילקח בלא תחבולה',
          '2212': 'תילקח בלא תחבולה',
          '2211': 'לא תילקח כלל',
          '2112': 'מלחמה ומערכה, אך לא לקיחת העיר (אם מתהפכת — לקיחה במלחמה קשה)',
          '1111': 'מלחמה ומערכה, אך לא לקיחת העיר (אם מתהפכת — לקיחה במלחמה קשה)',
          '2121': 'מלחמה ומערכה, אך לא לקיחת העיר',
          '2111': 'מלחמה ומערכה, אך לא לקיחת העיר',
          '2221': 'מלחמה ומערכה, אך לא לקיחת העיר',
          '1112': 'מלחמה ומערכה, אך לא לקיחת העיר',
        },
        label: 'האם עיר תילקח (עמ׳ 212)',
        sourceText: 'אם נשאלת על עיר — האם תילקח או לא — התבונן בבית הרביעי. אם מצאת בו ממון יוצא, העיר תילקח בתחבולה. ואם נשוא ראש או לבן — תילקח בלא תחבולה. ואם כבוד נכנס — לא תילקח כלל. וכן חיבור/דרך/ממון נכנס/סף נכנס/שפל ראש/סף יוצא מורים על מלחמה ומערכה, אך אינם מורים על לקיחת העיר. וכל צורה מתהפכת מורה על לקיחה במלחמה קשה.',
      },
      {
        id: 'war-advice',
        checkType: 'house-dakhal-kharij',
