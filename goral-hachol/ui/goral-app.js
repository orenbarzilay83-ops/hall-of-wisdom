...
function renderConceptsGuide() {
  ...
  const concepts = [
    ...
    { title: 'הכוונה הנסתרת', sub: 'מה באמת רוצה השואל', body: 'הכוונה הנסתרת מחושבת ממאזן ארבעת היסודות: אש, אוויר, מים, עפר. היא מכוונת לבית מסוים בלוח המגלה את ה"שאלה האמיתית" שבלב השואל — לפעמים שונה משאלתו המוצהרת.' },
