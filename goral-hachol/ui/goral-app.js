...
function renderConceptsGuide() {
  ...
  const concepts = [
    ...
    { title: 'מניעה — מה חוסם את הדבר (حيلولة)', sub: 'שלושה גורמים שמונעים השלמה', body: 'גם כשנראה שהדבר ייגמר, ישנם גורמים שיכולים לחסום: (1) דיין נחס שאינו מחובר לשואל ולנשאל — חוסם את הפסיקה. (2) צורת נחס בבית 12 — סכנה נסתרת שמפריעה. (3) צורת נחס בבית 8 — מטילה צל של הפסד על הדין.' },
    { title: 'תמכן — צורה בביתה הטבעי (التمكن)', sub: 'כשהצורה שנפלה היא הצורה הקבועה של הבית', body: 'לכל אחד מ-16 הבתים יש צורה קבועה השייכת לו. כשהצורה שנפלה בגורל זהה לצורה הקבועה של אותו בית — הדין מתחזק. אם הצורה טובה (סעד) — מתחזק לטובה. אם הצורה רעה (נחס) — מתחזק לרעה. לדוגמה: "נלחם" בבית 1 הוא ביתו הטבעי — הדין על השואל מתחזק לפי מזל נלחם.' },
