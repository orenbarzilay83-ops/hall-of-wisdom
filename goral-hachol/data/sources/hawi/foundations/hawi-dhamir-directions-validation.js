export const HAWI_DHAMIR_DIRECTIONS_VALIDATION = {
  ...
  forcedOrChosenTravelRules: [
    {
      ...
      hebrew:
        'אם העולה מביט לבית 3 או לבית 9 במבט שאינו משובח — השואל נוסע שלא ברצונו, בכפייה.',
    },
    {
      ...
      hebrew:
        'אם העולה בבית 3, 9 או 14 — הוא מבקש את הנסיעה מעצמו ואינו מוכרח עליה.',
    },
  ],
  ...
  moonValidationRules: {
    ...
    principleHebrew:
      'הלבנה היא מקור החיים החיוניים והיא המייצג של בעל השאלה; מה שפוגע בה פוגע בבעל השאלה בטוב או ברע.',
    moonForms: [
      {
        arabicName: 'البياض',
        hebrewName: 'לבן',
  ...
  dangerTravelRules: [
    {
      ...
      hebrew:
        'אם העולה בסוקֵט/נופל או נוטה, המזיקים מעידים לו או מביטים אליו, והוא עצמו מזיק/מנוחס, והלבנה בנפילה/חולשה או אינה מביטה לבית הראשון וכן השמש — נסיעתו עליו ולא לטובתו.',
    },
    {
    ...
    },
    {
      ...
      hebrew:
        'אם מביט ממנו מזיק — מת באותה נסיעה.',
    },
    {
      ...
      hebrew:
        'אם המיטיבים מביטים והלבנה מביטה ממקומות טובים — הוא יסבול פחדים וקשיים אך יינצל מהם.',
    },
  ],
