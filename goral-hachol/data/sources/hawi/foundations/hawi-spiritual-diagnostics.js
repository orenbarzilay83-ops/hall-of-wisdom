export const HAWI_SPIRITUAL_DIAGNOSTICS = {
  ...
  rules: [
...

    {
      ...
      sourceStatus: 'explicit-in-current-source-file',
      appDisplayHebrew:
        'בשער החולי, סוהר בבית 6 מורה על מחלה פנימית/חבויה, ואם חזרה בבית 8 — סכנת מוות; ייתכן רעל או הכשת נחשים עם עדות מזיקים.',
      caution:
...

    {
      ...
      sourceStatus: 'engine-implemented',
      appDisplayHebrew:
        'שער המולד פעיל במנוע birthNativity: בית 1 = בעל העולה, חזרת הצורה בבתים אחרים = משמעויות חיים. כולל ידיעת נסתרות, קהאנא, רמל וכוכבים.',
      religiousAdaptation:
...

    {
      ...
      sourceStatus: 'engine-implemented',
      appDisplayHebrew:
        'שער עולה השנה ושער הגשם פעילים במנוע yearlyForecast: יסודות, כוכבים, ירח, גשם, קור, שלג, רוחות. הדין על נושא yearlyForecast בלבד, לא מעורב בדיני שאלה פרטית.'
    },
  ],
