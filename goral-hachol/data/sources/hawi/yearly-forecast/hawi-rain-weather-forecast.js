export const HAWI_RAIN_WEATHER_FORECAST = {
  ...
  rainStrengthRules: [
    {
      ...
      hebrew:
        'אם החצי הראשון חזק בעצמו, והעד והדליל שלו מעידים כך — יהיה בעזרת ה׳ גשם רב השוטף/כולל את אותה ארץ ואותה עיר.',
      condition: 'חצי ראשון חזק + עד ודליל מחזקים',
      result: 'גשם רב וכללי',
      topics: ['גשם רב', 'עד', 'דליל', 'כוח'],
    },
    {
  ...
  advancedWeatherRules: [
    ...
    },
    {
      ...
      hebrew:
        'אם צדק בדלילות המטר — ינשבו רוחות סוערות.',
    ...
    },
    {
      ...
      hebrew:
        'אם הדלילות מצד שבתאי — מורה על גשמים מתמשכים.',
