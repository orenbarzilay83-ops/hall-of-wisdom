export const HAWI_QUESTION_DEATH_INHERITANCE = {
  ...
  rules: [
    ...
    },
    {
      ...
      hebrewTranslation: [
        'בית 8 מיטיב = היורש יקבל את חלקו.',
        'בית 8 מזיק = הירושה מוטלת בספק או מעוכבת.'
      ],
      houses: [8],
      figures: [],
      technicalTerms: ['البيت الثامن', 'سعد', 'نحيس', 'الوارث', 'الميراث'],
      rule: 'בית 8 מיטיב = יורש יקבל חלקו; מזיק = ירושה בספק/מעוכבת.',
      status: 'sourceExact'
    },
    {
    ...
    },
    {
      ...
      hebrewTranslation: [
        'דיין (בית 15): מיטיב = היורש יקבל הירושה; מזיק = היורש יחרם.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الدايان', 'البيت الخامس عشر', 'الوارث', 'الحرمان'],
      rule: 'דיין (בית 15): מיטיב = ירושה תינתן; מזיק = חרמה מהירושה.',
      status: 'sourceExact'
    }
  ],
  summary: {
    hebrew: 'שאלת המוות והירושה נבחנת דרך בית 8 (מוות/ירושה), בית 7 (הנפטר/בעל הירושה) ובית 2 (הממון שיעבור). בית 8 מיטיב = יורש יקבל חלקו; מזיק = ירושה בספק. חזרת צורת בית 8 בבית 2 = מעבר קל. הדיין (בית 15) פוסק.',
    appDisplayHebrew: 'בשאלת ירושה: בית 8 = מוות/ירושה, בית 7 = הנפטר, בית 2 = הממון. בית 8 מיטיב = יורש יקבל; מזיק = בספק. הדיין (בית 15) פוסק.'
  }
};
