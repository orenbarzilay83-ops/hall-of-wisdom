export const HAWI_QUESTION_BIRTH_NATIVITY = {
  ...
  sourceSectionHebrew: 'שער המולד — העולה האישי וגורל האדם',
  ...
  rules: [
    {
      ...
      hebrewTranslation: [
        'בית 1 הוא העולה (עולה) — שורש האדם, מזגו וחייו.'
      ],
      houses: [1],
      figures: [],
      technicalTerms: ['الطالع', 'البيت الأول', 'أصل الإنسان', 'مزاج'],
      rule: 'בית 1 = העולה (אסצנדנט) — שורש האדם, טבעו ואורח חייו.',
      status: 'sourceExact'
    },
    {
  ...
  summary: {
    hebrew: 'שאלת המולד בודקת את העולה האישי דרך בית 1 כשורש האדם, חזרת הצורה בבתים אחרים כגילוי פני הגורל, ובתים 7/10/4/8 לעמדות חיים שונות. הדיין (בית 15) פוסק את הגורל הכללי.',
    appDisplayHebrew: 'בשאלת מולד: בית 1 = העולה, בית 10 = קריירה/כבוד, בית 7 = אויבים, בית 4 = סוף/רכוש, בית 8 = מוות/תמורה. חזרת צורת בית 1 בבתים אחרים = גילוי פני הגורל.'
  }
};
