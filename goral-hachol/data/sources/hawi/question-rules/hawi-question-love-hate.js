...
const HAWI_QUESTION_LOVE_HATE = {
  ...
  rules: [
...

    {
      ...
      hebrewTranslation: [
        "ואם בתחילת ההכאה יצאה אחת משתי הצורות האלה — קבץ ח׳ארג׳ או קבץ דאחל — הרי שהוא אוהב אותו ונמנע ממנו."
      ],
      houses: [],
      figures: [
        "القبض الخارج",
      ...
      rule: "קבץ ח׳ארג׳ או קבץ דאחל בתחילת ההכאה — יש אהבה, אבל יש גם מניעה או הימנעות.",
      status: "sourceExact"
    }
  ],
  summary: {
