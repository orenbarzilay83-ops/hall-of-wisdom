...
export const HAWI_QUESTION_COMPLETION = {
  ...
  rules: [
...

    {
      ...
      hebrewTranslation: [
        "ואם היה להפך ממה שהזכרנו: צורות יוצאות ומזיקיות, כמו ממון יוצא, סף יוצא, והדרך, והן חזרו במקומות רעים כמו השישי, השמיני, השלישי והשנים־עשר."
      ],
      houses: [6, 8, 3, 12],
      figures: [
        "القبض الخارج",
      ...
      rule: "צורות יוצאות ומזיקיות כגון ממון יוצא, סף יוצא והדרך, החוזרות במקומות רעים 6,8,3,12 — סימן הפוך מהצלחה, קושי חמור/ביטול/אי־השלמה.",
      status: "sourceExact"
    },
