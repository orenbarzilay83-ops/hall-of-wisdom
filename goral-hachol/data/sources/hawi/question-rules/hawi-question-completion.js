...
const HAWI_QUESTION_COMPLETION = {
  ...
  rules: [
...

    {
      ...
      hebrewTranslation: [
        "ובמיוחד אם הסעדים מעידים אל הסעדים — זה הטוב ביותר."
      ],
      houses: [],
      figures: [],
      technicalTerms: [
      ...
      rule: "עדות סעדים לסעדים היא החיזוק הטוב ביותר למילוי הצורך.",
      status: "sourceExact"
    },
...

    {
      ...
      hebrewTranslation: [
        "ואם נולדו/התפתחו בבתים הנחסיים — כמו השני, השלישי, השישי, השמיני והארבעה־עשר — צורות טובות ונכנסות, אז הצורך יתמלא אחרי שכמעט תיפסק תקוותו.",
      ...
      rule: "צורות טובות ונכנסות הנולדות בבתי נחס 2,3,6,8,14 — הצורך יתמלא, אבל אחרי ייאוש כמעט מוחלט, עמל, עייפות, טרחה, הלוך וחזור בלי תועלת.",
      status: "sourceExact"
    },

    {
      ...
      hebrewTranslation: [
        "ואם היה להפך ממה שהזכרנו: צורות יוצאות ונחסיות, כמו קבץ ח׳ארג׳, עתבה ח׳ארג׳ה, והדרך, והן חזרו במקומות רעים כמו השישי, השמיני, השלישי והשנים־עשר."
      ],
      houses: [6, 8, 3, 12],
      figures: [
        "القبض الخارج",
      ...
      rule: "צורות יוצאות ונחסיות כגון קבץ ח׳ארג׳, עתבה ח׳ארג׳ה והדרך, החוזרות במקומות רעים 6,8,3,12 — סימן הפוך מהצלחה, קושי חמור/ביטול/אי־השלמה.",
      status: "sourceExact"
    },
