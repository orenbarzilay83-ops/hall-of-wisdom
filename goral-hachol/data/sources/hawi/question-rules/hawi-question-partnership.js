export const HAWI_QUESTION_PARTNERSHIP = {
  ...
  rules: [
    ...
    },
    {
      ...
      hebrewTranslation: [
        'בית 2 ובית 10 שניהם מיטיב = שותפות רווחית.',
        'שניהם מזיק = אין רווח.'
      ],
      houses: [2, 10],
      figures: [],
      technicalTerms: ['البيت الثاني', 'البيت العاشر', 'سعد', 'نحيس', 'ربح'],
      rule: 'בית 2+10 מיטיב = שותפות רווחית; מזיק = לא כדאי.',
      status: 'sourceExact'
    },
    {
    ...
    },
    {
      ...
      hebrewTranslation: [
        'דיין (בית 15): מיטיב = שותפות תצליח; מזיק = כישלון או הפסד.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الدايان', 'البيت الخامس عشر', 'سعد', 'نحيس', 'نجح'],
      rule: 'דיין (בית 15): מיטיב = שותפות מוצלחת; מזיק = הפסד.',
      status: 'sourceExact'
    },
    {
      ...
      hebrewTranslation: [
        'אם צורת בית 7 היא מזיק — הזהר מהשותפות עם אדם זה.'
      ],
      houses: [7],
      figures: [],
      technicalTerms: ['البيت السابع', 'نحيس', 'تحذير', 'شراكة'],
      rule: 'בית 7 מזיק = אזהרה מהשותפות.',
      status: 'sourceExact'
    }
  ],
  summary: {
    hebrew: 'שאלת השותפות נבחנת דרך ציר בית 1 (שואל) מול בית 7 (שותף), ובית 2 (ממון שואל) מול בית 8 (ממון שותף). חזרת צורת בית 1 בבית 7 = שותף מתאים. בית 2+10 מיטיב = רווח. הדיין (בית 15) פוסק אם השותפות תצלח. בית 7 מזיק = אזהרה.',
    appDisplayHebrew: 'בשאלת שותפות: בית 1 = השואל, בית 7 = השותף. חזרת צורת בית 1 בבית 7 = שותפות טובה. בית 2+10 מיטיב = רווח. הדיין (בית 15) פוסק.'
  }
};
