export const HAWI_QUESTION_PARTNERSHIP = {
  ...
  rules: [
    ...
    {
      id: 'partnership-rule-8',
      order: 8,
      arabicText: [
        'في سؤال الاتصال والشراكة والزواج وأخذ المال أو إعطائه: انظر انقلاب البيت الخامس عشر',
        'إذا خرج من شكلين داخلين فهو دليل الاتصال والاقتران',
        'إذا خرج من شكلين خارجين فهو دليل الفراق وعدم الاتصال'
      ],
      hebrewTranslation: [
        'בשאלת חיבור/שותפות/נישואין/כסף: בדוק את ה"אנקלאב" (ההיפוך) של בית 15.',
        'אם יוצא משתי צורות נכנסות — סימן לחיבור והתקשרות.',
        'אם יוצא משתי צורות יוצאות — סימן לפירוד ואי-התקשרות.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الانقلاب', 'الاتصال', 'الشراكة', 'داخل', 'خارج'],
      rule: 'אנקלאב בית 15: נכנס+נכנס = חיבור/שותפות; יוצא+יוצא = פירוד.',
      sourceNote: 'الفلك المشحون في علم الرمل المصون',
      status: 'sourceExact'
    },
    {
      id: 'partnership-rule-9',
      order: 9,
      arabicText: [
        'في سؤال الفراق والانفصال وفسخ الشراكة: الحكم ينعكس',
        'إذا خرج الانقلاب من شكلين خارجين — الفراق سيقع',
        'إذا خرج من شكلين داخلين — لا يقع الفراق في القريب',
        'الأشكال الثابتة تدل على البقاء على الحال',
        'الأشكال المنقلبة تدل على التحول والتغيير'
      ],
      hebrewTranslation: [
        'בשאלת פירוד/סיום שותפות — הדין מתהפך:',
        'אנקלאב יוצא+יוצא = הפירוד יקרה.',
        'אנקלאב נכנס+נכנס = הפירוד לא יקרה בקרוב.',
        'צורות קבועות = המצב הנוכחי נשאר.',
        'צורות מתהפכות = שינוי ותמורה.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الانقلاب', 'الفراق', 'الانفصال', 'ثابت', 'منقلب'],
      rule: 'לפירוד: אנקלאב יוצא+יוצא = פירוד יהיה; נכנס+נכנס = לא יפרדו; קבוע = מצב נשאר; מתהפך = שינוי.',
      sourceNote: 'الفلك المشحون في علم الرمل المصون',
      status: 'sourceExact'
    }
  ],
  summary: {
    hebrew: 'שאלת השותפות נבחנת דרך ציר בית 1 (שואל) מול בית 7 (שותף), ובית 2 (ממון שואל) מול בית 8 (ממון שותף). חזרת צורת בית 1 בבית 7 = שותף מתאים. בית 2+10 סעד = רווח. מנגנון החיבור: אנקלאב בית 15 עם שתי צורות נכנסות = חיבור; יוצאות = פירוד. לפירוד — הדין מתהפך. הדיין (בית 15) פוסק.',
    appDisplayHebrew: 'בשאלת שותפות: בית 1 = השואל, בית 7 = השותף. חזרת צורת בית 1 בבית 7 = שותפות טובה. בית 2+10 סעד = רווח. אנקלאב נכנס+נכנס = שותפות תקום; יוצא+יוצא = לא. הדיין (בית 15) פוסק.'
  }
};
