export const HAWI_QUESTION_PRISONER = {
  ...
  rules: [
    ...
    },
    {
      ...
      hebrewTranslation: [
        'אם בית 5 הוא מיטיב — השחרור בא.'
      ],
      houses: [5],
      figures: [],
      technicalTerms: ['البيت الخامس', 'سعد', 'الخروج'],
      rule: 'בית 5 מיטיב = שחרור קרב.',
      status: 'sourceExact'
    },
    {
      id: 'prisoner-rule-7',
      ...
      hebrewTranslation: [
        'דיין מיטיב + בית 5 מיטיב = שחרור ודאי.',
        'שניהם מזיק = מאסר ממושך.'
      ],
      houses: [5, 15],
      figures: [],
      technicalTerms: ['الدايان', 'سعد', 'نحيس', 'الخروج محقق', 'السجن طويل'],
      rule: 'דיין מיטיב + בית 5 מיטיב = שחרור ודאי; שניהם מזיק = מאסר ממושך.',
      status: 'sourceExact'
    },
    {
      id: 'prisoner-rule-8',
  ...
  summary: {
    hebrew: 'שאלת האסיר נחקרת דרך בית 12 (כלא), בית 1 (האסיר), בית 5 (גורל/מזל — המפתח) ודיין (בית 15). חיבור בין בית 1 לבית 12 = עדיין כלוא. מיטיב בבית 5 + דיין מיטיב = שחרור ודאי. חזרות צורת בית 1 בלוח = אורך המאסר.',
    appDisplayHebrew: 'בשאלת אסיר: בית 12 = כלא, בית 1 = האסיר, בית 5 = גורל (מפתח), דיין (בית 15) = פסיקה. בית 5 מיטיב + דיין מיטיב = שחרור ודאי. חזרות צורת בית 1 = אורך מאסר.'
  }
};
