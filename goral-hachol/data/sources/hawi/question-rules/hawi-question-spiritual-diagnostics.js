 ...
 * כולל: כישוף לפי בית+צורה, סוג ג׳ין (15×4), איסקאט 7×7, אבחון איברים (8×6)
 */
...
export const HAWI_QUESTION_SPIRITUAL_DIAGNOSTICS = {
  ...
  rules: [
    ...
    },
    {
      ...
      hebrewTranslation: [
        'בשיטת האיסקאט: סופרים את פתיחת הרמל ומחסירים 7–7.',
      ...
      rule: 'איסקאט 7×7: שארית 1=ג׳ין; 2=קנאה/עין; 3=כישוף מאדם; 4=ליחה/מים; 5=דם/אוויר; 6=מרה שחורה/עפר; 7=מרה צהובה/אש.',
      status: 'explicit-in-user-approved-screenshot'
    },
    {
      ...
      hebrewTranslation: [
        ...
        'ראה את הטאלע (ב1) ובית המחלה (ב6) ואת מה שנוצר מהם.',
  ...
  summary: {
    ...
    diagnosticMethods: ['איסקאט 7×7', 'שיטת 15×4 (סוג ג׳ין)', 'שיטת 8×6 (אבחון איברים)', 'צורה×בית'],
