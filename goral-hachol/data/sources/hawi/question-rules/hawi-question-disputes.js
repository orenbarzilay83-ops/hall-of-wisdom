...
export const HAWI_QUESTION_DISPUTES = {
  ...
  rules: [
...

    {
      ...
      hebrewTranslation: [
        "אחר כך הסתכל בבית הראשון ובמה שחלה בו מן הצורות.",
      ...
      rule: "בית 1 טוב ובו השתתפות של מיטיב — השואל גובר.",
      status: "sourceExact"
    },

    {
      ...
      hebrewTranslation: [
        "אם העולה, או הצורה שחלה בו, נוטה אל צורות השמש — הוא מבקש להתלונן/לתבוע אצל הסולטאן/השלטון."
      ],
      houses: [1],
      figures: [],
      technicalTerms: [
      ...
      rule: "נטיית העולה או צורתו אל צורות השמש — פנייה לשלטון/סמכות עליונה.",
      status: "sourceExact"
    },
...

    {
      ...
      hebrewTranslation: [
        ...
        "מי מהם שהוא מיטיב, נכנס, חזק בעצמו, ויש לו כוח באותו בית, וצורות טובות מביטות ממנו — הוא הגובר."
      ],
      houses: [1, 7],
      figures: [],
      technicalTerms: [
