export const HAWI_QUESTION_MISSING_PERSON_EXTRA = {
  ...
  returnRules: [
    ...
    },
    {
      ...
      sourcePage: 59,
      hebrew:
        'צורות נכנסות, במיוחד כאשר הן קשורות לבית הראשון או לבית השביעי, מחזקות את דין החזרה.',
      result: 'חזרה מתחזקת',
    },
    {
      ...
      sourcePage: 59,
      hebrew:
        'צורות יוצאות או חוסמות סביב העולה/השביעי/התשיעי מראות עיכוב, מניעה או ריחוק.',
      result: 'עיכוב / מניעה',
    },
    {
      ...
      sourcePage: 59,
      hebrew:
        'אם מזיקים נמצאים בבתי הדרך, הפחד, החולי או המוות — הדבר מורה על סכנה, פחד, כלא, חולי או רעה בדרך.',
      houses: [6, 8, 9, 12],
  ...
  lifeDeathRules: [
    {
      ...
      sourcePage: 60,
      hebrew:
        'בדיקת חי/מת נעשית לפי קשרי בית 8, בית 4, בית 12, בית 6, הצורות המזיקיות והעדים.',
      houses: [4, 6, 8, 12],
    ...
    },
    {
      ...
      sourcePage: 60,
      hebrew:
        'מיטיבים, צורות חוזרות לטובה, ותמיכת העדים מורים שהנעדר חי או שיש תקווה לחזרתו.',
      result: 'חי / תקווה',
    },
    {
      ...
      sourcePage: 60,
      hebrew:
        'מזיקים בבתי מוות, פחד, כלא או חולי, ובפרט אם הם מתחברים לבית 8 או מעידים ממנו — מורים על סכנת מוות או רעה גדולה.',
      result: 'סכנת מוות',
    },
    {
      id: 'false-news-rule',
      sourcePage: 60,
      hebrew:
        'המקור כולל הבחנה בין ידיעה אמיתית לבין שמועה שקרית; אין לפסוק רק משמועה בלי בדיקת העדים והמייצג.',
  ...
  timingAndConditionRules: [
    ...
    },
    {
      ...
      sourcePage: 59,
      hebrew:
        'כאשר בית 6, 8 או 12 מעורבים במזיק — יש לבדוק פחד, כלא, חולי, סכנה, עיכוב או צרה בדרך.',
      houses: [6, 8, 12],
  ...
  specificReturnCombinations: [
    ...
    },
    {
      ...
      hebrew: 'ממון יוצא בבית 9 וחוזר בבית 16 — חשש למוות בגלות או בארץ זרה.',
      houses: [9, 16],
    ...
    },
    {
      ...
      hebrew: 'ממון יוצא בבית 9 בלבד — אפשרות לחזרה לאחר זמן רב.',
      houses: [9],
      figuresArabic: ['القبض الخارج'],
  ...
  specificDeathRules: [
    ...
    },
    {
      ...
      hebrew: 'חזרה בבית 14 או 8 כשהיא מזיקית, או הולדת צורה יוצאת מזיקית כנגדה/תחתיה — סימן מוות.',
      houses: [8, 14],
      result: 'סימן מוות',
    },
    {
      ...
      hebrew: 'בעל בית 1 בבית 4 כמזיק, בית 4 צורה נכנסת מזיקית, ותחתיו יוצאת מזיקית — מוות.',
      houses: [1, 4],
      result: 'מוות',
    },
    {
      ...
      hebrew: 'בית 1 ובית 14 כצורות יוצאות, חוזרות במקומות נופלים/מזיקיים ומולידות מזיק — מוות.',
      houses: [1, 14],
      result: 'מוות',
    },
    {
      ...
      hebrew: 'בשאלת נעדר, סף יוצא וממון יוצא הן הצורות המזיקיות ביותר — מורות על מוות.',
    ...
    },
    {
      ...
      hebrew: 'מזיקים באמהות או בבנות ומתחתיהם צורות נכנסות — קלקול/פגם, ואין הנעדר שלם/בטוח.',
      result: 'קלקול / סכנה',
    },
    {
      ...
      hebrew: 'מיטיבים חזקים המביטים אל בית המוות — מבטלים/מרככים את דין המוות.',
      houses: [8],
    ...
    },
    {
      ...
      hebrew: 'מזיקים המביטים אל בית המוות — מחזקים הכרעת מוות.',
      houses: [8],
    ...
    },
    {
      ...
      hebrew: 'בתים 1, 9 ו-13 כולם מזיקיים, וחזרה בבית 12 או זיווג עם מזיקים — פסוק מוות.',
      houses: [1, 9, 12, 13],
