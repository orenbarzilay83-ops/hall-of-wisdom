export const HAWI_QUESTION_SEA_VOYAGE = {
  ...
  rules: [
    ...
    },
    {
      ...
      hebrewTranslation: [
        'אם צורת בית 9 סעד וצורת בית 8 סעד — המסע בטוח.'
      ],
      houses: [8, 9],
      figures: [],
      technicalTerms: ['سعد', 'الرحلة البحرية', 'آمنة'],
      rule: 'סעד בבית 9 + סעד בבית 8 = מסע בטוח.',
      status: 'sourceExact'
    },
    {
      ...
      hebrewTranslation: [
        'אם כל אחד מבתים 9, 8, 12 הוא נחס — יש סכנה בים.'
      ],
      houses: [8, 9, 12],
      figures: [],
      technicalTerms: ['نحيس', 'خطر', 'البحر'],
      rule: 'נחס בכל אחד מבתים 9/8/12 = סכנה בים.',
      status: 'sourceExact'
    },
    {
    ...
    },
    {
      ...
      hebrewTranslation: [
        'דיין (בית 15): סעד = חזרה בשלום; נחס = סכנה/אובדן.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الدايان', 'سعد', 'نحيس', 'عودة سالمة', 'خسارة'],
      rule: 'דיין (בית 15): סעד = חזרה בשלום; נחס = סכנה או אובדן.',
      status: 'sourceExact'
    }
  ],
  summary: {
    hebrew: 'שאלת מסע הים בודקת ארבעה בתים: בית 1 (הנוסע), בית 9 (המסע), בית 8 (סכנת טביעה), בית 12 (סכנות נסתרות). סעד בבתים 9+8 = מסע בטוח; נחס בכל אחד מהם = סכנה. כיוון צורת בית 9 מגלה מסע או עיכוב. הדיין (בית 15) פוסק את הסוף.',
    appDisplayHebrew: 'במסע ים: בית 9 = המסע, בית 8 = טביעה/סכנה, בית 12 = נסתר. סעד בשניהם = בטוח. נחס בכל אחד = סכנה. דיין (בית 15) = פסיקה סופית.'
  }
};
