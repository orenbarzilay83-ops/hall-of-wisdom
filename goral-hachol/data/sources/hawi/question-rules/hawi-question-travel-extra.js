export const HAWI_QUESTION_TRAVEL_EXTRA = {
  ...
  chosenOrForcedTravelRules: [
    ...
    },
    {
      ...
      hebrew:
        'אם הטאלע בבית 3, 9 או 14 — השואל מבקש את הנסיעה מעצמו ואינו מוכרח עליה.',
      result: 'נסיעה מרצון',
      houses: [3, 9, 14],
    },
  ],
  ...
  moonTravelRules: [
    {
      ...
      hebrew:
        'הלבנה היא מקור החיים החיוניים והיא הדליל של בעל השאלה.',
  ...
  dangerAndReturnRules: [
    {
      ...
      hebrew:
        'אם הטאלע נופל/סוקט או נוטה, הנחסים מעידים לו או מביטים אליו, והוא נחס או מנוחס, והלבנה בפגע/נפילה או אינה מביטה לטאלע, וכן השמש — נסיעתו עליו ולא לטובתו.',
      result: 'נסיעה לרעת השואל',
      topics: ['נחס', 'לבנה', 'שמש', 'סכנה'],
    },
    {
    ...
    },
    {
      ...
      hebrew:
        'אם מביט ממנו נחס — הוא מת באותה נסיעה.',
      result: 'מוות בנסיעה',
      topics: ['נחס', 'מוות'],
    },
    {
      ...
      hebrew:
        'אם הסעדים מביטים והלבנה מביטה ממקומות טובים — הוא סובל פחדים וקשיים אך ניצל מהם.',
      result: 'קשיים ולאחריהם הצלה',
      topics: ['סעד', 'לבנה', 'הצלה'],
    },
  ],
