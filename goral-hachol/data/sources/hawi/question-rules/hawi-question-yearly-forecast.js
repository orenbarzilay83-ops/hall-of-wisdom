export const HAWI_QUESTION_YEARLY_FORECAST = {
  ...
  sourceSectionHebrew: 'שער עולה השנה — גשם, מחירים ומלכים',
  ...
  summary: {
    hebrew: 'שאלת עולה השנה בודקת שלושה אפיקים עיקריים: הדיין (בית 15) לאיכות השנה הכללית, בית 10 לגשם וחקלאות ומחירים, ובית 2 למצב הכלכלי. בית 7 מגלה מלחמות וסכסוכים. צורות אש בבית 10 = בצורת; צורות מים = גשם.',
