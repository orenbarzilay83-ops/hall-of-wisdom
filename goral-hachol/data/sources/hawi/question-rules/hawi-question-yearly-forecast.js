export const HAWI_QUESTION_YEARLY_FORECAST = {
  ...
  rules: [
    {
      ...
      hebrewTranslation: [
        ...
        'סעד = שנה טובה; נחס = שנה קשה.'
      ],
      houses: [15],
      figures: [],
      technicalTerms: ['الدايان', 'جودة السنة', 'سعد', 'نحيس'],
      rule: 'דיין (בית 15): סעד = שנה טובה; נחס = שנה קשה.',
      status: 'sourceExact'
    },
    {
    ...
    },
    {
      ...
      hebrewTranslation: [
        ...
        'סעד = זול ושפע; נחס = יוקר ומחסור.'
      ],
      houses: [2],
      figures: [],
      technicalTerms: ['البيت الثاني', 'رخص', 'غلاء', 'وفرة', 'شح'],
      rule: 'בית 2: סעד = שנה של זול ושפע; נחס = שנה של יוקר ומחסור.',
      status: 'sourceExact'
    },
    {
    ...
    },
    {
      ...
      hebrewTranslation: [
        'רוב צורות סעד בלוח = שנה משגשגת.',
        'רוב צורות נחס = שנה קשה.'
      ],
      houses: [],
      figures: [],
      technicalTerms: ['غلبة الأشكال', 'سعيدة', 'نحوس', 'مزدهرة'],
      rule: 'רוב סעד = שנה טובה; רוב נחס = שנה קשה.',
      status: 'sourceExact'
    },
    {
  ...
  summary: {
    ...
    appDisplayHebrew: 'בשאלת השנה: דיין (בית 15) = איכות כללית, בית 10 = גשם/חקלאות, בית 2 = כלכלה/מחירים, בית 7 = מלחמות. רוב סעד = שנה טובה; רוב נחס = שנה קשה.'
  }
};
