export const HAWI_QUESTION_SIBLINGS = {
  ...
  summary: {
    hebrew: 'שאלת האחים והשכנים נבחנת דרך בית 3 (האח/שכן) מול בית 1 (השואל). חזרת צורת בית 3 בבית 1 = האח יסייע. בית 3 סעד = אח יכול לעזור; נחס = אח במצוקה. בית 11 = חברים ומכרים. הדיין (בית 15) פוסק.',
