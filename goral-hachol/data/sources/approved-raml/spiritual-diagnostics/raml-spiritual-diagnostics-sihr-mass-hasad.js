export const RAML_SPIRITUAL_DIAGNOSTICS_SIHR_MASS_HASAD = {
  ...
  openingRules: [
    {
      ...
      hebrewTranslation: [
        ...
        "ובייחוד צורת עקלה מורה על אישה מכשפת."
      ],
      figures: ["العقلة"],
      planets: ["زحل"],
      topics: ["כישוף", "שבתאי", "אישה מכשפת", "עקלה"],
    ...
    },
    {
      ...
      hebrewTranslation: [
        "צורת אנקיס מורה על הפסד, עצב, כישלון ומועקת/צרות החזה."
      ],
      figures: ["الأنكيس"],
    ...
    },
    {
      ...
      hebrewTranslation: [
        "צורת חיבור / اجتماع מורה על מכשף רע ופגום.",
  ...
  figureHouseRules: [
    {
      ...
      hebrewTranslation: ["אנקיס בבית 6 — קבור לו כישוף בקבר."],
      figure: "الأنكيس",
      house: 6,
    ...
    },
    {
      ...
      hebrewTranslation: ["ג׳ודלה בבית 6 — זהו כישוף שנשתה."],
      figure: "الجودلة",
      house: 6,
    ...
    },
    {
      ...
      hebrewTranslation: ["ג׳ודלה בבית 12, בית האויבים — הוא קשור/חסום מאשתו."],
      figure: "الجودلة",
      house: 12,
    ...
    },
    {
      ...
      hebrewTranslation: ["קבץ דאח׳ל בבית 6 — הוא קשור וחסום מן הנשים."],
      figure: "القبض الداخل",
      house: 6,
    ...
    },
    {
      ...
      hebrewTranslation: ["אחיאן / נושא ראש בבית 10 — גם הוא מכושף."],
      figure: "الأحيان",
      house: 10,
      diagnosis: "bewitched",
    ...
    },
    {
      ...
      hebrewTranslation: ["עקלה בבית 13 — הוא קשור; יש לו כישוף, וגם נזרק/פוזר עליו דבר."],
      figure: "العقلة",
      house: 13,
    ...
    },
    {
      ...
      hebrewTranslation: [
        "עקלה בבית 14 — ביתו בכישוף, או שיש כישוף תלוי בבית או במקום שעליו מפילים את הגורל ושואלים."
      ],
      figure: "العقلة",
      house: 14,
    ...
    },
    {
      ...
      hebrewTranslation: ["היווצרות ג׳מאעה משתי חומרה — הוא מקונא בקנאה חזקה מאוד מאוד."],
      figure: "الجماعة",
    ...
    },
    {
      ...
      hebrewTranslation: [
        "היווצרות ג׳מאעה משני אנקיס — קבורים לו שני כשפים בלי ספק, ואף יותר מזה; והמכשף מחדש לו את הכישוף בכל תקופה."
      ],
      figure: "الجماعة",
    ...
    },
    {
      ...
      hebrewTranslation: [
        "אם ג׳מאעה באה בבית 6 — יש אצלה תַאבִּעַה / אם הצביאן; היא מונעת ומשבשת את נישואיה, ואם תינשא לא תלד; ואם תיכנס להריון תפיל; ואם תלד — הדבר פוגע בילדיה."
      ],
      figure: "الجماعة",
      house: 6,
  ...
  jinnTypeRules: [
    ...
    },
    {
      ...
      conditionHebrew: "אם תוצאת 15×4 היא אותה צורה רביעית, כלומר ג׳מאעה באה במאזן",
  ...
  isqatSevenRules: {
    ...
    results: [
      ...
      },
      {
        ...
        hebrew: "אם נשאר 6 — זו מחלת סודא/מרה שחורה גופנית, מיוחסת לעפר.",
      ...
      },
      {
        ...
        hebrew: "אם נשאר 7 — זו מחלת צפרא/מרה צהובה גופנית, מיוחסת לאש.",
