...
export const KASHF_TOPICS_PER_HOUSE = {
  ...
  4: {
    ...
    topics: [
      ...
      { label: 'קידוח בארות / עומק מים',  description: 'האם יש מים, באיזה עומק, אכדאד אל-הנדי',           implemented: true,  topicId: 'foundations',             sourceNote: 'source: kashf' },
  ...
  5: {
    ...
    topics: [
      ...
      { label: 'מצב הילדים',             description: 'כשף עמ׳ 194: ב6 נחס = מחלות בגיל הרך; ב8 סעד = ישתפר. [ממומש ב-childrenPregnancyKashf]',      implemented: true, topicId: 'childrenPregnancy', sourceNote: 'source: kashf p.193-194' },
      { label: 'אורך חיים של הילד',      description: 'כשף עמ׳ 194: ב5+16 שניהם סעד = אושר ועושר; שניהם נחס = ירוד; מעורב = בינוני. [ממומש ב-childrenPregnancyKashf]',                  implemented: true, topicId: 'childrenPregnancy', sourceNote: 'source: kashf p.194' },
  ...
  9: {
    ...
    topics: [
      ...
      { label: 'מיקום הנעדר',            description: 'כשף עמ׳ 246-250: ב7=בית הנעדר; ב9+10 = כיוון; ב5 סעד = קרוב לבית; ב6 ממון-יוצא = בגלות. [ממומש ב-missingPersonLocation]',  implemented: true, topicId: 'missingPerson',    sourceNote: 'source: kashf p.246-250' },
      { label: 'האם הנעדר יחזור',        description: 'כשף עמ׳ 246-251: ב14 נשוא-ראש/כבוד-נכנס=יחזור; ב1+ב7 סעד=סיכוי טוב; ב6 ממון-יוצא=סכנת מוות בגלות. [ממומש ב-missingPersonReturn]',      implemented: true, topicId: 'missingPerson',    sourceNote: 'source: kashf p.246-251' },
  ...
  10: {
    ...
    topics: [
      ...
      { label: 'מלך / שליט — האם מפחד', description: 'PDF1 p.53: ch.19 — الفصل التاسع عشر أحكام الملوك والحكام. אם מריח׳ חוזר בב10 עם נחס גדול = השליט בסכנה מאויב',                              implemented: true,  topicId: 'authorityState',     sourceNote: 'source: PDF1 p.53' },
