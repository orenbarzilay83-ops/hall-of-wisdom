...
// חודשי הלוח ההיג'רי. המקור המודפס מאפשר במפורש:
// - יותר מצורה אחת לאותו חודש;
// - יותר מחודש אחד לאותה צורה.
// לכן אין להפוך את המפה ליחס אחד-לאחד.
// כל 12 החודשים מופיעים במקור; בר הלחי (1211) היא הצורה היחידה שאינה
// מקבלת שיוך חודש מפורש בפרק הזה.
// ─────────────────────────────────────────────────────────────────────────
export const FIGURE_MONTHS = {
  ...
  certainty: {
    ...
    confidence: 'high',
    ambiguity: false,
    visualDependency: 'printed-scan-p102-103',
  },

  completenessPolicy: {
    sourceIsPartial: true,
    allTwelveMonthsRepresented: true,
    unassignedFigureMeaning: 'not_stated_in_source',
    mustNotInferMissingAssignments: true,
    mustNotForceOneMonthPerFigure: true,
    mustNotForceOneFigurePerMonth: true,
    mustNotFillFromOtherTradition: true,
  },

  byMonth: {
    'רמדאן':             ['1222'],                  // נשוא ראש / الأحيان
    ...
    'מוחרם':             ['2212'],                  // לבן
    'צפר':               ['1122'],                  // כבוד יוצא
    "ד׳ו אל־קעדה":       ['2211'],                  // כבוד נכנס
    "ד׳ו אל־חג׳ה":       ['2112', '1111'],          // חיבור, דרך
  },

  // הצורה היחידה שאינה משויכת לחודש מפורש בפרק הזה:
  unassignedFigures: ['1211'], // בר הלחי / نقي الخد
};
