...
### מצב Pass 2 לאחר בדיקת עמ׳ 43–165

- `lastCompletedReviewEntry`: `gate5.p165.figure-proximity-extended`
- `lastCompletedPrintedRange`: **162–165**
- `lastCompletedScanRange`: **164–167**
- `nextReviewEntry`: `gate6.house1.p167.hidden-work-diagnostic`
- `nextReviewPrintedRange`: **167**
- `nextReviewScanRange`: **169**
- `reviewRequiredStatusCount`: **90** — שלוש רשומות נוספות נבדקו בעמ׳ 162–165; `gate5.p162-163.derekh-house-rules` נסגרה ל־VERIFIED לאחר אימות שה-v57 הנוכחי תואם למקור, ושתי רשומות הקרבה נשארו REVIEW_REQUIRED בגלל פערי v57/מקור חיים.
- `pass2ReviewedEntries`: **30 / 90**
- `pass2UnauditedReviewEntries`: **60**
- `VERIFIED`: **181**
- `latestMergedPass2PR`: **#48**
- `PR #48 merge SHA`: `f291c5e237623c011fffa65251cb91f8ff0d8a0b`
...
`gate6.house1.p167.hidden-work-diagnostic`
