...
const tests = [
  ...
  {
    label: 'פירוש חלום (dreamInterpretation)',
    question: 'ראיתי בחלום שאני עולה על הר גבוה — מה משמעות החלום',
    // H9=נשוא ראש(1222/סעד) H1=חיבור(2112/ממוזג-סעד)
    mothers: ['2112', '1222', '2211', '1111'],
    topicId: 'dreamInterpretation',
  },
  {
