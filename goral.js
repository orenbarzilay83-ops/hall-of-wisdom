...
const G_TABLES = {
  א:{rows:[
    ...
    goralParseTable("ז-יד-יב-יא-יא-א-יג-א-יא"),
...
function goralFormatAnswer(raw){
  ...
  const spacingOnly = [
    ...
    ["מזרממרומימ", "מזר ממרומימ"],
    ["שתשרתרצהלכ", "שתשרת רצה לכ"],
    ["רבונעולמימ", "רבונ עולמימ"],
    ["יעזורלכבזה", "יעזור לכ בזה"],
    ["ויטיבכבזאת", "ויטיבכ בזאת"],
    ["מסכימלכבזה", "מסכימ לכ בזה"],
    ["בליתנהרצונ", "בל יתנ הרצונ"],
    ["אתהשואלא", "אתה שואל א"],
    ["להצליחכבזה", "להצליחכ בזה"],
