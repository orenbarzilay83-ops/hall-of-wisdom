  ...
  houseQuestionRules: {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 1",
          rule: "בודקים את הצורה העומדת בבית 1: טבעה, מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים.",
          implementationReady: true
        },
        {
          id: "house-1-strength",
        ...
        },
        {
          ...
          rule: "במודול הרוחני בית 1 הוא החולה / האדם שעליו שואלים.",
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 2",
          rule: "בודקים את הצורה בבית 2: האם היא מיטיב/מזיק/ממוזג, יסוד, קל/כבד, פתוח/סגור, נכנס/יוצא אם יש קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-2-strength",
        ...
        },
        {
          ...
          rule: "בודקים האם בית 1 והשואל תומכים בבית 2 או מתנגדים לו: חזרת צורה, התאמת יסודות, מיטיב/מזיק, וחיבור דרך דמיר/עדים אם קיים.",
          implementationReady: true
        },
        {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 3",
          rule: "בודקים את הצורה בבית 3: האם היא מיטיב/מזיק/ממוזג, יסוד, קל/כבד, פתוח/סגור, נכנסת/יוצאת אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-3-strength",
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 4",
          rule: "בודקים את הצורה בבית 4: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-4-strength",
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 5",
          rule: "בודקים את הצורה בבית 5: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-5-strength",
    ...
    house6IllnessServiceTroubleRules: {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 6",
          rule: "בודקים את הצורה בבית 6: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-6-strength",
        ...
        },
        {
          ...
          title: "הפלת פתיחת גורל החול 7-7 באבחון רוחני",
          rule: "במודול הרוחני קיימת ספירת פתיחת גורל החול (מפתוח אל-רמל) והפלה 7-7: 1 ג׳ין, 2 חסד/עין, 3 סחר מאדם, 4 מים/ליחה, 5 אוויר/דם, 6 עפר/מרה שחורה, 7 אש/מרה צהובה.",
          relatedFile: "raml-spiritual-diagnostics.js",
          displayPolicy: "advisorOnly / spiritualDiagnostic",
          implementationReady: true
        },
      ...
      spiritualDiagnosticLinks: {
        ...
        houseRoles: [
          {
            house: 1,
            role: "החולה / האדם שעליו שואלים"
          },
          {
            house: 4,
            role: "התרופה / פתרון / שורש ריפוי"
          },
          {
            house: 6,
            role: "בית המחלה"
          ...
          {
            house: 9,
            role: "הסוחר/מכשף או עוסק בעבודה רוחנית"
          },
          {
            house: 10,
            role: "רופא / מרפא / מטפל"
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 7",
          rule: "בודקים את הצורה בבית 7: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-7-strength",
    ...
    house8DeathLossFearInheritanceRules: {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 8",
          rule: "בודקים את הצורה בבית 8: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-8-strength",
        ...
        },
        {
          ...
          rule: "בודקים אם בית 8 משפיע ישירות על השואל: חזרת צורה, ניגוד יסודות, מיטיב/מזיק, קשר לעדים או לשופט.",
          implementationReady: true
        },
        {
      ...
      occultSpiritualTopics: {
        ...
        coreMeaning: [
          ...
          "בית 8 אינו מחליף את בית 9 במודול הרוחני: בית 9 יכול להראות המכשף / בעל העבודה הרוחנית.",
        ...
        diagnosticChecks: [
          ...
          "לבדוק האם בית 8 מקבל צורה מזיקית, כבדה, סגורה, יוצאת/נכנסת לפי הקידוד המאומת.",
        ...
        relatedSpiritualDiagnosticsRules: [
          {
            ...
            use: "ספירת פתיחת גורל החול (מפתוח אל-רמל) והפלה 7-7: ג׳ין, חסד/עין, סחר מאדם, ומחלות לפי יסודות."
          },
          {
    ...
    house9TravelReligionDreamSpiritualRules: {
      ...
      coreMeaning: [
        ...
        "במודול האבחון הרוחני בית 9 מוגדר כבית המכשף/בעל עבודה רוחנית.",
      ...
      questionTypes: [
        ...
        },
        {
          ...
          note: "לפי המודול הרוחני בית 9 הוא בית המכשף/בעל עבודה רוחנית. יש לבדוק בית 6 מחלה, בית 8 כובד/פחד/הפסד, בית 10 מטפל/מרפא/תוצאה, בית 12 אויב נסתר/סוד."
        },
        {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 9",
          rule: "בודקים את הצורה בבית 9: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
          id: "house-9-strength",
        ...
        },
        {
          ...
          rule: "במודול הרוחני בית 9 הוא בית המכשף/בעל העבודה הרוחנית. בודקים אותו כאשר יש שאלה על סחר, כישוף, ג׳ין, רוחות, כהאנה, עראפה או שעודה.",
          relatedFile: "raml-spiritual-diagnostics.js",
          implementationReady: true
        },
        {
    ...
    house10AuthorityWorkResultRules: {
      ...
      coreMeaning: [
        ...
        "במודול האבחון הרוחני בית 10 הוא הרופא, המרפא או המטפל.",
      ...
      questionTypes: [
        ...
        },
        {
          ...
          note: "במודול הרוחני בית 10 הוא הרופא/המרפא/המטפל; בית 6 מחלה; בית 4 תרופה/שורש ריפוי; בית 8 כובד/סכנה; בית 12 נסתר."
        },
        {
      ...
      whatToInspect: [
        {
          ...
          title: "הצורה בבית 10",
          rule: "בודקים את הצורה בבית 10: מיטיב/מזיק/ממוזג, יסוד, פתוח/סגור, קל/כבד, נכנס/יוצא אם קיים קידוד מאומת.",
          implementationReady: true
        },
        {
        ...
        },
        {
          ...
          rule: "במודול הרוחני בית 10 הוא הרופא, המרפא או המטפל. בשאלות חולי/פגיעה רוחנית בודקים אותו מול בית 6, בית 4, בית 8 ובית 12.",
          relatedFile: "raml-spiritual-diagnostics.js",
          implementationReady: true
        },
        {
