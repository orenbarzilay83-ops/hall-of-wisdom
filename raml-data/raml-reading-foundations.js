...
const RAML_READING_FOUNDATIONS = {
  ...
  relativeHouseRule: {
    ...
    rules: [
      ...
      { offset: 5,  meaning: "שמחה, ילדים, פרי, תענוג ומיטיב של הבית" },
      { offset: 6,  meaning: "מחלה, חולשה, מזיק, סוד או עבדות של הבית" },
  ...
  incomingTimeRules: {
    ...
    ruleHebrew: [
      ...
      "הדין תלוי גם במיטיב/מזיק של הצורה ובמצבה בשלוש הבחינות."
    ],
    implementationReady: false,
    needsExactFormula: [
      ...
      "להגדיר מה פירוש שלוש הבחינות שבהן בודקים מיטיב ומזיק."
    ]
  },
